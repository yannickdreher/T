...
public partial class SessionsPanel : UserControl
{
    ...
    private SessionsTreeViewModel? Vm => DataContext as SessionsTreeViewModel;
    ...
    private void OnDragOver(object? sender, DragEventArgs e)
    {
        ...
        if (targetNode == _draggedNode ||
            (_draggedNode.IsFolder && targetNode != null && SessionsTreeViewModel.IsDescendantOf(targetNode, _draggedNode)))
        {
            e.DragEffects = DragDropEffects.None;
            ClearDropTarget();
            return;
